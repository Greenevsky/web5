...
$checkResult = $connection->query("SELECT 1 FROM `Пользователи` WHERE `Пароль` = '$value'");
...
$updateResult = $connection->query("UPDATE `Пользователи` SET `Пароль` = '$value' WHERE `id` = $sessionId");
